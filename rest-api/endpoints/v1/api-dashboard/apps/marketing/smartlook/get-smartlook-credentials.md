# Buscar credenciais do SmartLook

{% api-method method="get" host="https://dev-api.xekout.app" path="/v1/admin/apps/smartlook/:subdomain" %}
{% api-method-summary %}
Buscar credenciais do SmartLook
...

{
  "status": "error",
  "code": 404004,
  "message": "Tokens for app SmartLook not found"
}
```
{% endapi-method-response-example %}
