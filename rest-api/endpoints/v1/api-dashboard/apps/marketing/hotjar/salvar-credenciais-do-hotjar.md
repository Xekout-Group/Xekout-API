# Salvar credenciais do Hotjar

{% api-method method="post" host="https://dev-api.xekout.app" path="/v1/admin/apps/hotjar/:subdomain" %}
{% api-method-summary %}
Salvar credenciais do Hotjar
...
```text
{
  "status": "success",
  "code": 201000,
  "message": "App Hotjar saved successfuly"
}
```
