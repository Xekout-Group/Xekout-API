# Salvar informações do app Tawk

{% api-method method="post" host="https://dev-api.xekout.app" path="/v1/admin/apps/paypal/:subdomain" %}
{% api-method-summary %}
...
```text
{
  "status": "success",
  "code": 200004,
  "message": "App AppTawk update successfuly"
}
```
